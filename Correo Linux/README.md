...
- Ejemplo de configuracion de una cuenta:

![](img/014.png)

![](img/015.png)

- No tenemos servicio de recepcion de correo por ahora asi que elegimos ninguno.
...
- Lo instalaremos desde su pagina web y utilizaremos estos comandos:

```
#Descargamos el archivo desde la pagina web
...
#Cambiamos el propietario y permisos de el contenido
...
#Cambiamos el nombre de la carpeta para hacerlo mas sencillo
sudo mv /var/www/html/squirrelmail-webmail-1.4.22/ /var/www/html/squirrelmail
```
- Una vez ejecutado los comandos, ejecutaremos este ultimo para lanzar el script de configuracion:
...
- Cambiamos el nombre del dominio en la opcion 1 "Domain"
...
- Elegimos la opcion 4 "General Options"

![](img/034.png)

- Cambiaremos esas dos rutas, ya que en los comandos que hemos ejecutado antes, moviamos el contenido a la carpeta /var/www/html/
...
- Iniciamos sesion tanto en cliente como servidor con un usuario distinto.
...
![](img/039.png)
> Vemos como nos aparecen tanto el primero correo de prueba que hicimos via telnet como el correo que hicimos con el Evolution.
...
- Ejemplo de creacion con ambos protocolos.
